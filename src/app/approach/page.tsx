  ...
  return (
    <>
      ...
      <section className='flex not-lg:flex-col'>
        <div className='z-1 flex-1 bg-teal-800 py-12 pr-12 pl-[10vw] text-white not-lg:[clip-path:polygon(0%_0%,100%_0%,100%_95%,50%_100%,0%_95%)] lg:justify-self-end lg:[clip-path:polygon(0%_0%,95%_0%,100%_50%,95%_100%,0%_100%)]'>
          <h3 className='mb-4'>
        ...
        <div className='flex-1 bg-teal-100 py-12 pr-[10vw] pl-[94px] not-lg:mt-[-40px] lg:ml-[-70px]'>
