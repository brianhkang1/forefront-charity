  ...
  return (
    <Dialog.Root>
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content
          className='data-[state=open]:animate-dialog-content-show fixed top-1/2 left-1/2 z-4 max-h-[70vh] w-[480px] -translate-x-1/2 -translate-y-1/2 rounded-2xl shadow-md not-md:max-w-[90vw] focus:outline-none'
          aria-describedby={undefined} //resolves browser warning
        >
          <VisuallyHidden.Root>
